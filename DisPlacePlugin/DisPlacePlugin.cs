...
namespace DisPlacePlugin
{
    public sealed class DisPlacePlugin : IDalamudPlugin
    {
        ...
        public DisPlacePlugin(IDalamudPluginInterface pi)
        {
            ...
            DalamudApi.PluginLog.Info("DisPlace Plugin v3.7.4 initialized");
        }
        public void Initialize()
        {
            ...
            MaybePlaceh = HookManager.Hook<MaybePlaced>("40 55 56 57 48 8D AC 24 70 FF FF FF 48 81 EC 90 01 00 00 48 8B 05 CE 39 04 02", MaybePlace); // MaybePlace0 // They added two methods with similar signatures in 7.2
